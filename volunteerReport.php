...
<html>
    <head>
        ...
        <title>Empowerhouse's VMS | Volunteer History</title>
        ...
        <main class="hours-report">
            ...
            <?php if (count($events)  > 0): ?>
                <div class="table-wrapper"><table class="general">
                    ...
                    <p class="print-only">I hereby certify that this volunteer has contributed the above volunteer hours to the Empowerhouse organization.</p>
